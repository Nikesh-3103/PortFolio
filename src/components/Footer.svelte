...
>
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        ...
        <p><b class="pr-2">Email :</b><a href="mailto:nikeshkumar3103@gmail.com">nikeshkumar3103@gmail.com</a></p>
        <p>
            <b class="pr-2">LinkedIn :</b>
            <a href="https://www.linkedin.com/in/nikesh-kumar-415929258" target="_blank" rel="noopener noreferrer" class="text-violet-400">
                Nikesh Kumar
                <sup>
